...
A list of practical projects that anyone can solve in any programming language (). These projects are divided in multiple categories, and each category has its own folder. Repository is forked from [github.com/karan](https://github.com/karan/Projects)

In moments of random boredom, when my brain craves stimulation but there's nothing to provide, my hands begin to itch, and my ears hallucinate the clicking of keyboard switches. I will try to complete all of them, one by one.

Solutions will be included in `solutions` directory but there is also an outbound link to other solutions.
...
- [Numbers](https://github.com/morphzg/project_ideas/#numbers)
- [Classic Algorithms](https://github.com/morphzg/project_ideas/#classic-algorithms)
- [Graph](https://github.com/morphzg/project_ideas/#graph)
- [Data Structures](https://github.com/morphzg/project_ideas/#data-structures)
- [Text](https://github.com/morphzg/project_ideas/#text)
- [Networking](https://github.com/morphzg/project_ideas/#networking)
- [Classes](https://github.com/morphzg/project_ideas/#classes)
- [Threading](https://github.com/morphzg/project_ideas/#threading)
- [Web](https://github.com/morphzg/project_ideas/#web)
- [Files](https://github.com/morphzg/project_ideas/#files)
- [Databases](https://github.com/morphzg/project_ideas/#databases)
- [Graphics and Multimedia](https://github.com/morphzg/project_ideas/#graphics-and-multimedia)
- [Security](https://github.com/morphzg/project_ideas/#security)
...
Solutions by other developers - [solutions](https://github.com/thekarangoel/Projects-Solutions)
My own approach to solving problems - [/solutions](https://github.com/MorphZG/project_ideas/tree/master/solutions)
